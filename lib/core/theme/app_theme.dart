...
class MaterialTheme {
  ...
  static const customColor1 = ExtendedColor(
    seed: Color(0xff6be39b),
    value: Color(0xff6be39b),
    light: ColorFamily(
      color: Color(0xff2c6a45),
      onColor: Color(0xffffffff),
      colorContainer: Color(0xffb0f1c3),
      onColorContainer: Color(0xff0f512f),
    ),
    ...
    dark: ColorFamily(
      color: Color(0xff95d5a8),
      onColor: Color(0xff00391e),
      colorContainer: Color(0xff0f512f),
      onColorContainer: Color(0xffb0f1c3),
    ),
